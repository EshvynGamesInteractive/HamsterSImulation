...
public class FP_Controller : MonoBehaviour
{
    ...
    public void DoTrampolineJump(float force)
    {
...
//    public void EnterHeistMode()
//    {
//        GetComponent<FP_CameraLook>().headBob.BobHeight = 0.05f;
//        walkSpeed = 0.5f;
//        runSpeed = 0.5f;
//        crouchSpeed = 0.5f;
//    }
...
//    public void ExitHeistMode()
//    {
//        GetComponent<FP_CameraLook>().headBob.BobHeight = 0.5f;
//        walkSpeed = 1f;
//        runSpeed = 1.5f;
//        crouchSpeed = 1f;
//    }
...
//        if (grounded && moveDirection.y < 0)
//    moveDirection.y = -1f; // small negative to keep grounded but prevent bounce
...
//        if (jumpState == 0 && CanStand() && jump && jumpTimer >= antiBunnyHopFactor)
//        {
//            //PlaySound(footSteps.jumpSound, JumpLandSource);//khubaib
//            jumpState++;
//        }
