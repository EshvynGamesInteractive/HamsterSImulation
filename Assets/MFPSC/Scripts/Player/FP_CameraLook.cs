...
public class FP_CameraLook : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        PlayerHead.localPosition.x, playerController.controller.center.y + playerController.controller.height / 2 - 0.25F, PlayerHead.localPosition.z), 0.15F * 1.2f);
    ...
    void FixedUpdate()
    {
        ...
        yPos = bobFactor * headBob.BobHeight * headBobFade * speedHeightFactor;
